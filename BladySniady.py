...
# --- SZABLON HTML (Zwykły string, bez f-stringa!) ---
html_template = """
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="hero">
        ...
        <div class="live-badge"><div class="dot"></div>VAR_LIVE_TEXT</div>
    </div>
    <section id="stats" class="reveal">
        <div class="stats">
            <div class="stat"><h4>VAR_FOLS</h4><p>Followers</p></div>
            <div class="stat"><h4>VAR_WINS</h4><p>Wins</p></div>
            <div class="stat"><h4>VAR_HOURS</h4><p>Hours</p></div>
        </div>
    </section>
    <script>
