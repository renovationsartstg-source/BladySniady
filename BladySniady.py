...
# Ukrywamy elementy Streamlit, żeby interfejs był czysty jak w grze
st.markdown("""
    <style>
        ...
        [data-testid="stAppViewContainer"] {background-color: #050507;}
    </style>
""", unsafe_allow_html=True)

# 2. DEFINICJA ARENA_HTML (Zwróć uwagę na zamknięcie na samym dole)
arena_html = """
<!DOCTYPE html>
<html lang="pl">
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .auth-card { 
            ...
            text-align: center; box-shadow: 0 0 50px rgba
