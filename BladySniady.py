...
styles = [
    ...
    # SZKLANE KARTY Z NEONOWYM OBRYSEM
    ...
    '.bg-dc { background: #5865F2; color: white; border-bottom: 4px solid #3a45c3; }',
    '.bg-kick { background: #53FC18; color: black; border-bottom: 4px solid #3dbd10; }',
    '.bg-yt { background: #FF0000; color: white; border-bottom: 4px solid #b30000; }',
    '.bg-tt { background: #000; color: white; border: 1px solid #00f2ea; border-bottom: 4px solid #ff0050; }',
    
    # HARMONOGRAM
    '.sched-row { display: flex; justify-content: space-between; padding: 12px 5px; border-bottom: 1px solid rgba(255,255,255,0.05); }',
    '.day-label { color: #888; font-size: 11px; font-weight: 700; }',
    '.time-label { font-family: "Orbitron", sans-serif; color: #ff0000; font-weight: 900; }',
    '</style>'
]
...
if st.session_state.view == 'home':
    ...
    st.markdown('<h1 class="neon-title" style="font-size: 100px; margin-bottom: 0;">BLADY</h1>', unsafe_allow_html=True)
    st.markdown('<h1 class="neon-title" style="font-size: 60px; margin-top: -30px; opacity: 0.8;">SNIADY</h1>', unsafe_allow_html=True)
    st.markdown('<p style="text-align:center; color:#555; letter-spacing:15px; text-transform:uppercase; font-size:12px; margin-bottom:50px;">Digital Combat Hub</p>', unsafe_allow_html=True)
