...
# Ukrywamy elementy interfejsu Streamlit (header, footer, menu), aby strona wyglądała czyściej
hide_st_style = """
            <style>
...
<head>
    ...
    <style>
        *{ margin:0; padding:0; box-sizing:border-box; scroll-behavior:smooth; }
        ...
        nav h1{ color:#ff2e2e; letter-spacing:3px; font-size: 24px; }
        nav a{ color:white; text-decoration:none; margin-left:30px; transition:0.3s; font-size: 14px; }
        ...
        .hero h2{ font-size:clamp(40px, 8vw, 75px); font-weight:900; text-shadow:0 0 30px red; line-height: 1.1; }
        .hero p{ margin:20px 0 40px; color:#aaa; font-size: 18px; }
...
# Ustawiamy wysokość na 100vh lub konkretną wartość w pikselach
